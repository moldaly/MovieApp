...
//enum Winner: String {
//    case draw = "draw"
//    case playerone = "player 1 wins"
//    case playertwo = "player 2 wins"
//}

//func weakness(playerOneChoice: Choice, playerTwoChoice: Choice) -> Winner {
//    switch (playerOneChoice, playerTwoChoice) {
//    case (.rock, .rock):     return .draw
//    case (.rock, .paper):    return .playertwo
//    case (.rock, .scissors): return .playerone
//
//    case (.paper, .rock):     return .playerone
//    case (.paper, .paper):    return .draw
//    case (.paper, .scissors): return .playertwo
//
//    case (.scissors, .rock):     return .playertwo
//    case (.scissors, .paper):    return .playerone
