...
//        if genres[indexPath.row].id == 1 {
//            
//        } else if genres[indexPath.row].id == 2 {
//            cell.movieImage.image = movies[indexPath.row].image
//            cell.movieName.text = movies[indexPath.row].name
//        }
